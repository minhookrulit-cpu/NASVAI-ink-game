# NASVAI
Roblox Scripts Collection for Various Games
...
- **Anti Stun** - Prevent stun effects
- **Infinite Jump** - Jump indefinitely
- **Auto Tug of War** - Auto-complete QTE
- **Auto Hide & Seek** - Teleport to height
...
## 📝 Requirements
- Roblox executor with HTTP GET support
- Working executor with Instance new
